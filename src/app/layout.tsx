...
export const metadata: Metadata = {
  title: "Brew Haven - Craft Coffee & Community",
  description: "Specialty coffee shop with freshly roasted beans, expert baristas, and cozy atmosphere. Visit Brew Haven for your daily coffee fix.",
  keywords: "coffee shop, specialty coffee, latte, cappuccino, local cafe",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Brew Haven - Craft Coffee & Community",
    description: "Specialty coffee shop with freshly roasted beans and warm hospitality.",
    type: "website",
    siteName: "Brew Haven",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36N98T78GiMXZxciGAJmSwlCklc/uploaded-1764837535745-8pb6av83.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven - Craft Coffee & Community",
    description: "Specialty coffee shop with freshly roasted beans and expert baristas.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36N98T78GiMXZxciGAJmSwlCklc/uploaded-1764837535745-8pb6av83.jpg"]
  }
};
